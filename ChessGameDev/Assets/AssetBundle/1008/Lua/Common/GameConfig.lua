...
function GameConfig:InitProtoConfig()
	...
	self.LineConfigByte={
		[1] = {name = "SoundConfigList",path = "Common/config/SoundConfigData.bytes",data="SoundConfig_1008.SoundConfigData"},
	}
end
...
function GameConfig:InitGameAtlasConfig()
	self.GameSpriteAtlas={
		["FKDHZSpriteAtlas"]="Common/Atlas/FKDHZSpriteAtlas.spriteatlas",	
