...
function ParticleManager:InitAllEffect()
	for i=1,#self.AllEffectObjList do
		GameObjectPoolManager.GetInstance():AddGameObjectPool(self.AllEffectObjList[i],30,self.AllEffectObjList[i].name,GameObjectPoolManager.PoolType.EffectPool)
	end
end
...
function ParticleManager:SetParabolaItemEffect(startPos,endPos,score)
