...
function FishOutTipsEffecItem:FindView()
	...
	self.NormalAnim=tf:Find("FishOutTips"):GetComponent(typeof(CS.UnityEngine.Animation))
end
...
function FishOutTipsEffecItem:PlaySpineAnim()
...
function FishOutTipsEffecItem:PlayNormalAnim()
	if self.NormalAnim then
