...
function PlayerStartView:FindPlayerStartView(tf)
	...
	self.AutoCountPanel=tf:Find("Down/Stop/StopBtn/AutoCount").gameObject
	self.AutoText=tf:Find("Down/Stop/StopBtn/AutoCount/Text"):GetComponent(typeof(self.Text))
...
function PlayerStartView:InitViewData()
	...
	self:IsShowAutoCountPanel(false)
end
...
function PlayerStartView:IsShowAutoCountPanel(isShow)
	CommonHelper.SetActive(self.AutoCountPanel,isShow)
end
