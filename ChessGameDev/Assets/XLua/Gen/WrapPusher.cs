...
namespace XLua
{
    public partial class ObjectTranslator
    {
        ...
        class IniterAdderUnityEngineVector2
        {
			...
			static void Init(LuaEnv luaenv, ObjectTranslator translator)
			{
				...
				translator.RegisterPushAndGetAndUpdate<TcpLcClient.NetworkStatus>(translator.PushTcpLcClientNetworkStatus, translator.Get, translator.UpdateTcpLcClientNetworkStatus);
				translator.RegisterPushAndGetAndUpdate<FishLuaBehaviour.FishStatus>(translator.PushFishLuaBehaviourFishStatus, translator.Get, translator.UpdateFishLuaBehaviourFishStatus);
				translator.RegisterPushAndGetAndUpdate<GameVersionStatus>(translator.PushGameVersionStatus, translator.Get, translator.UpdateGameVersionStatus);
        ...
        int TcpLcClientNetworkStatus_TypeID = -1;
		int TcpLcClientNetworkStatus_EnumRef = -1;
        
        public void PushTcpLcClientNetworkStatus(RealStatePtr L, TcpLcClient.NetworkStatus val)
        {
            if (TcpLcClientNetworkStatus_TypeID == -1)
            {
			    bool is_first;
                TcpLcClientNetworkStatus_TypeID = getTypeId(L, typeof(TcpLcClient.NetworkStatus), out is_first);
				
				if (TcpLcClientNetworkStatus_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(TcpLcClient.NetworkStatus));
				    TcpLcClientNetworkStatus_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, TcpLcClientNetworkStatus_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, TcpLcClientNetworkStatus_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for TcpLcClient.NetworkStatus ,value="+val);
            }
			
			LuaAPI.lua_getref(L, TcpLcClientNetworkStatus_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out TcpLcClient.NetworkStatus val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != TcpLcClientNetworkStatus_TypeID)
				{
				    throw new Exception("invalid userdata for TcpLcClient.NetworkStatus");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for TcpLcClient.NetworkStatus");
                }
				val = (TcpLcClient.NetworkStatus)e;
                
            }
            else
            {
                val = (TcpLcClient.NetworkStatus)objectCasters.GetCaster(typeof(TcpLcClient.NetworkStatus))(L, index, null);
            }
        }
		
        public void UpdateTcpLcClientNetworkStatus(RealStatePtr L, int index, TcpLcClient.NetworkStatus val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for TcpLcClient.NetworkStatus ,value="+val);
                }
            }
        ...
        int FishLuaBehaviourFishStatus_TypeID = -1;
		int FishLuaBehaviourFishStatus_EnumRef = -1;
        
        public void PushFishLuaBehaviourFishStatus(RealStatePtr L, FishLuaBehaviour.FishStatus val)
        {
            if (FishLuaBehaviourFishStatus_TypeID == -1)
            {
			    bool is_first;
                FishLuaBehaviourFishStatus_TypeID = getTypeId(L, typeof(FishLuaBehaviour.FishStatus), out is_first);
				
				if (FishLuaBehaviourFishStatus_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(FishLuaBehaviour.FishStatus));
				    FishLuaBehaviourFishStatus_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, FishLuaBehaviourFishStatus_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, FishLuaBehaviourFishStatus_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for FishLuaBehaviour.FishStatus ,value="+val);
            }
			
			LuaAPI.lua_getref(L, FishLuaBehaviourFishStatus_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out FishLuaBehaviour.FishStatus val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != FishLuaBehaviourFishStatus_TypeID)
				{
				    throw new Exception("invalid userdata for FishLuaBehaviour.FishStatus");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for FishLuaBehaviour.FishStatus");
                }
				val = (FishLuaBehaviour.FishStatus)e;
                
            }
            else
            {
                val = (FishLuaBehaviour.FishStatus)objectCasters.GetCaster(typeof(FishLuaBehaviour.FishStatus))(L, index, null);
            }
        }
		
        public void UpdateFishLuaBehaviourFishStatus(RealStatePtr L, int index, FishLuaBehaviour.FishStatus val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for FishLuaBehaviour.FishStatus ,value="+val);
                }
            }
        ...
        int GameVersionStatus_TypeID = -1;
		int GameVersionStatus_EnumRef = -1;
        
        public void PushGameVersionStatus(RealStatePtr L, GameVersionStatus val)
        {
            if (GameVersionStatus_TypeID == -1)
            {
			    bool is_first;
                GameVersionStatus_TypeID = getTypeId(L, typeof(GameVersionStatus), out is_first);
				
				if (GameVersionStatus_EnumRef == -1)
				{
				    Utils.LoadCSTable(L, typeof(GameVersionStatus));
				    GameVersionStatus_EnumRef = LuaAPI.luaL_ref(L, LuaIndexes.LUA_REGISTRYINDEX);
				}
				
            }
			
			if (LuaAPI.xlua_tryget_cachedud(L, (int)val, GameVersionStatus_EnumRef) == 1)
            {
			    return;
			}
			
            IntPtr buff = LuaAPI.xlua_pushstruct(L, 4, GameVersionStatus_TypeID);
            if (!CopyByValue.Pack(buff, 0, (int)val))
            {
                throw new Exception("pack fail fail for GameVersionStatus ,value="+val);
            }
			
			LuaAPI.lua_getref(L, GameVersionStatus_EnumRef);
			LuaAPI.lua_pushvalue(L, -2);
			LuaAPI.xlua_rawseti(L, -2, (int)val);
			LuaAPI.lua_pop(L, 1);
        ...
        public void Get(RealStatePtr L, int index, out GameVersionStatus val)
        {
		    LuaTypes type = LuaAPI.lua_type(L, index);
            if (type == LuaTypes.LUA_TUSERDATA )
            {
			    if (LuaAPI.xlua_gettypeid(L, index) != GameVersionStatus_TypeID)
				{
				    throw new Exception("invalid userdata for GameVersionStatus");
				}
                ...
                if (!CopyByValue.UnPack(buff, 0, out e))
                {
                    throw new Exception("unpack fail for GameVersionStatus");
                }
				val = (GameVersionStatus)e;
                
            }
            else
            {
                val = (GameVersionStatus)objectCasters.GetCaster(typeof(GameVersionStatus))(L, index, null);
            }
        }
		
        public void UpdateGameVersionStatus(RealStatePtr L, int index, GameVersionStatus val)
        {
            ...
            if (LuaAPI.lua_type(L, index) == LuaTypes.LUA_TUSERDATA)
            {
                ...
                if (!CopyByValue.Pack(buff, 0,  (int)val))
                {
                    throw new Exception("pack fail for GameVersionStatus ,value="+val);
                }
            }
	...
	public partial class StaticLuaCallbacks
    {
	    internal static bool __tryArrayGet(Type type, RealStatePtr L, ObjectTranslator translator, object obj, int index)
		{
			...
			else if (type == typeof(TcpLcClient.NetworkStatus[]))
			{
			    TcpLcClient.NetworkStatus[] array = obj as TcpLcClient.NetworkStatus[];
				translator.PushTcpLcClientNetworkStatus(L, array[index]);
				return true;
			}
			else if (type == typeof(FishLuaBehaviour.FishStatus[]))
			{
			    FishLuaBehaviour.FishStatus[] array = obj as FishLuaBehaviour.FishStatus[];
				translator.PushFishLuaBehaviourFishStatus(L, array[index]);
				return true;
			}
			else if (type == typeof(GameVersionStatus[]))
			{
			    GameVersionStatus[] array = obj as GameVersionStatus[];
				translator.PushGameVersionStatus(L, array[index]);
				return true;
			}
