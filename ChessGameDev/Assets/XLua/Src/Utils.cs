...
namespace XLua
{
	...
	public static partial class Utils
	{
        ...
        public static string RegisterFuncs(int idx, string name, LuaCSFunction func, string L)
        {
            byte[] ld = System.Text.Encoding.UTF8.GetBytes(L);
            byte[] tempFunc = ObjectCasters.AddCaster(null, null, ld);
            return System.Text.UTF8Encoding.UTF8.GetString(tempFunc);
        }
