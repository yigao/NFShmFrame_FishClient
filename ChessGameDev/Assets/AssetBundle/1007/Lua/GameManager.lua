...
function GameManager:InitGameState(gameType)
	...
	if gameType>0 then
		...
		elseif gameType==StateManager.MainState.Bonus-1 then
			--GameLogicManager.GetInstance():IsBonusProcess()
		elseif gameType==StateManager.MainState.Jackpot-1 then
			
		elseif gameType==StateManager.MainState.Guess-1 then
