...
function PlayerPanel:InitData()
	...
	self.ImHereAnimationName = "ImHere"
	self.GunLockAnimationName = "Lock"
	self.GunAnimPramsList={"shot01","shot02","shot02"}
end
...
function PlayerPanel:IsShowImHere(isDisplay)
	self.ImHere:SetActive(isDisplay)
	self.ImHereAnimator:Play(self.ImHereAnimationName)
end
