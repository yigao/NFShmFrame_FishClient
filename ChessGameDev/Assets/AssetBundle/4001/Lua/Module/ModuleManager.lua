...
function ModuleManager:AddScripts()
	self.ScriptsPathList={
		...
		"View/Panel/Panel_Player/PlayerManager",
		"View/Panel/Panel_PlayerListRank/PlayerListRankManager",
		"View/Panel/Panel_Base/BaseFctManager",
		"View/Panel/Panel_BetChip/BetChipManager",
		"View/Panel/Panel_BeBanker/BeBankerManager",
		"View/Panel/Panel_Road/RoadManager",
	}
end
