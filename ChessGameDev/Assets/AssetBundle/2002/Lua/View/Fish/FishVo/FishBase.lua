...
function FishBase:BeginMove()
	...
	self.LuaBehaviour:FishBeginMove(self.FishVo.TraceId,self.FishVo.OffsetPosX,self.FishVo.OffsetPoxY,fishWidth,fishHeight,curPointIndex,self.FishVo.DelayBornTime,self.FishVo.usGroupId)
