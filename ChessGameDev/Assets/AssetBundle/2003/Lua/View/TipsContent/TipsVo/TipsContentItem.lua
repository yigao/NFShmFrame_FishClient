...
function TipsContentItem:FindView()
	...
	self.tipsText=self.tF:Find("Text"):GetComponent(typeof(self.Text))
	self.bgImage=self.tF:Find("Image"):GetComponent(typeof(self.Image))
...
function TipsContentItem:IsShowText(isShow)
	...
	CommonHelper.SetActive(self.bgImage.gameObject,isShow)
end
