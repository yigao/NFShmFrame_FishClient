LobbyChessRoomView = Class()

function LobbyChessRoomView:ctor()
    self.Room_Com_Path = CSScript.GlobalConfigManager.Hall_Name.."/Prefabs/LobbyRoomForm/LobbyRoomForm_"
    self:Init()
end

function LobbyChessRoomView:Init(  )
    self:InitData()
    self:InitView()
end

function LobbyChessRoomView:InitData(  )
...
function LobbyChessRoomView:InitView(  )
...
function LobbyChessRoomView:OpenForm()
    self:GetUIComponent()
    self:ShowUIComponent()
end

function LobbyChessRoomView:GetUIComponent()
...
function LobbyChessRoomView:ShowUIComponent()
...
function LobbyChessRoomView:SetHorizontalLayoutGroupParam( ... )
...
function LobbyChessRoomView:PlayAnimation(  )
...
function LobbyChessRoomView:IntroductionPointerClick(eventData)
    GlobalEventManager.GetInstance():DispatchEvent(LuaEventParams.OpenGameIntroduction_EventName)
end

function LobbyChessRoomView:CloseOnPointerClick(eventData)
    LobbyRoomSystem.GetInstance():RoomSwitchToLobby()
end

function LobbyChessRoomView:RemoveUIComponent()
    if self.uiFormScript ~= nil then
...
function LobbyChessRoomView:CloseForm()
    if self.uiFormScript ~= nil then
        XLuaUIManager.GetInstance():CloseForm(self.uiFormScript)
    end
end

function LobbyChessRoomView:__delete()
    for i = 1,#self.roomItemList do 
        self.roomItemList[i]:Destroy()
    end
	self:RemoveUIComponent()
