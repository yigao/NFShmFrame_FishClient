...
function GameConfig:InitGameBaseConfig()
	...
	self.IconItemTotalCount=11		--图标总数
...
function GameConfig:InitProtoConfig()
	...
	self.LineConfigByte={
		[1] = {name = "RoomConfig_1001List",path = "Common/config/RoomConfig_1001Data.bytes",data="RoomConfig_1001.RoomConfig_1001Data"},
		[2] = {name = "SoundConfigList",path = "Common/config/SoundConfigData.bytes",data="SoundConfig_1001.SoundConfigData"},
	}
end
...
function GameConfig:InitGameAtlasConfig()
	self.GameSpriteAtlas={
		["SGXMLSpriteAtlas"]="Common/Atlas/SGXMLSpriteAtlas.spriteatlas",
		["BaseSpriteAtlas"]="Common/Atlas/BaseSpriteAtlas.spriteatlas",
