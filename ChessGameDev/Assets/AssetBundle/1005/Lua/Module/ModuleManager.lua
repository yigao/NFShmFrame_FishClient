...
function ModuleManager:InitData()
	...
	self.PreLoadMoudeList={
		...
		[10]="AudioManager",
		[11]="HelpManager",
		[12]="IconSelectManager",
		[13]="HandselManager",
		[14]="SelectGameManager",
		[15]="ParticleManager",
	}
...
function ModuleManager:AddScripts()
	self.ScriptsPathList={
		...
		--"View/Panel/Panel_Bonus/BonusManager",
		"View/Panel/Panel_Win/WinManager",
		--"View/Panel/Panel_Line/LineManager",
		"View/Panel/Panel_Audio/AudioManager",
		"View/Panel/Panel_Help/HelpManager",
		"View/Panel/Panel_IconSelect/IconSelectManager",
		"View/Panel/Panel_Handsel/HandselManager",
		"View/Panel/Panel_SelectGame/SelectGameManager",
		"View/Panel/Panel_Particle/ParticleManager",
	}
end
