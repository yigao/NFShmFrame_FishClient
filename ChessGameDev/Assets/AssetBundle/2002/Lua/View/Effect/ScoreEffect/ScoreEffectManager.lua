...
function ScoreEffectManager:GetScoreEffectVo(scoreEffectConfig,chairID)
	local vo={}
...
function ScoreEffectManager:SetScoreEffectShowMode(tempFishTF,chairID,showScore,delayTimes,scoreEffectConfig)
	
	local scoreEffectVo=self:GetScoreEffectVo(scoreEffectConfig,chairID)
	local tempScoreEffectIns=self:GetScoreEffect(scoreEffectVo)
	if tempScoreEffectIns then
		tempScoreEffectIns:SetShowScoreText(showScore)
		local startPos=tempFishTF.parent:TransformPoint(tempFishTF.localPosition)
		tempScoreEffectIns:ResetState(startPos,delayTimes,scoreEffectVo.ScoreEffectConfig.scoreShowTime)
	end
