...
namespace XLua.CSObjectWrap
{
    ...
    public class RenderConfigWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(RenderConfig);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					RenderConfig gen_ret = new RenderConfig();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to RenderConfig constructor!");
        ...
        static int _g_get_sortingOrder(RealStatePtr L)
        {
		    try {
                ...
                RenderConfig gen_to_be_invoked = (RenderConfig)translator.FastGetCSObj(L, 1);
