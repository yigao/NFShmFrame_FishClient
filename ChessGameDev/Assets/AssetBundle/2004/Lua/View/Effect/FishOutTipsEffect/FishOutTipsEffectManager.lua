...
function FishOutTipsEffectManager:GetFishOutTipsEffectVo(resourceName,animationName,lifeTime)
	local vo={}
...
function FishOutTipsEffectManager:SetFishOutTipsEffectShowMode(resourceName,animationName,lifeTime)
	local FishOutTipsEffectVo=self:GetFishOutTipsEffectVo(resourceName,animationName,lifeTime)
...
function FishOutTipsEffectManager:__delete()
