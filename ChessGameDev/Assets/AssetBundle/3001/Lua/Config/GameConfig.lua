...
function GameConfig:InitProtoConfig()
	...
	self.LineConfigByte={
		[1] = {name = "SoundConfigList",path = "Common/config/SoundConfigData.bytes",data="SoundConfig_3001.SoundConfigData"},
	}
end
...
function GameConfig:InitGameAtlasConfig()
	self.GameSpriteAtlas={
		["QZNNBaseSpriteAtlas"]="Common/Atlas/QZNNBaseSpriteAtlas.spriteatlas",
		["QZNNCardSpriteAtlas"]="Common/Atlas/QZNNCardSpriteAtlas.spriteatlas",
}
end
