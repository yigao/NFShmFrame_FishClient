...
function GameManager:InitAddScripts()
	...
	self:AddScriptsPath("View/SmallGame/SmallGameManager")
...
function GameManager:GameAssetLoadCompleteCallBack()
	...
	AudioManager.GetInstance():PlayBGAudio(40,0.6)
...
function GameManager:LoadBinaryTraceFile(trackeCallBack)
	...
	--TODO判断玩家位置，计算炮台方向
	CS.FishManager.AccordingDeskLoadBinaryTraceFile(self.gameId,isRotation,trackeCallBack,true)
end
