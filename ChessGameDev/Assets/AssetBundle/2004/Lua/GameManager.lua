...
function GameManager:InitAddScripts()
	...
	self:AddScriptsPath("View/Effect/SpecialDeclareEffect/SpecialDeclareEffectManager")
	self:AddScriptsPath("View/Effect/SpiderCrabEffect/SpiderCrabEffectManager")
	...
	self:AddScriptsPath("View/Skill/ElectricSkill/ElectricSkillManager")
	self:AddScriptsPath("View/Skill/FireStormSkill/FireStormSkillManager")
	self:AddScriptsPath("View/Skill/DrillSkill/DrillSkillManager")
	self:AddScriptsPath("View/Skill/SerialDrillSkill/SerialDrillSkillManager")
	self:AddScriptsPath("View/Skill/BisonSkill/BisonSkillManager")
	self:AddScriptsPath("View/Skill/BombSkill/BombSkillManager")
	self:AddScriptsPath("View/Skill/MultBombSkill/MultBombSkillManager")

	
	self:AddScriptsPath("View/Set/GameSetManager")
	self:AddScriptsPath("View/Audio/AudioManager")
	self:AddScriptsPath("View/TipsContent/TipsContentManager")
end
...
function GameManager:InitUnityScripts()
	...
	self.SpriteRenderer=CS.UnityEngine.SpriteRenderer
end
...
function GameManager:GameAssetLoadCompleteCallBack()
	...
	AudioManager.GetInstance():PlayBGAudio(22,0.4)
...
function GameManager:__delete()
	...
	GoldEffectManager.GetInstance():Destroy()
	ScoreEffectManager.GetInstance():Destroy()
	PlusTipsEffectManager.GetInstance():Destroy()
	SpecialDeclareEffectManager.GetInstance():Destroy()
	SpiderCrabEffectManager.GetInstance():Destroy()
	BombManager.GetInstance():Destroy()
	FishEffectManager.GetInstance():Destroy()
	FishOutTipsEffectManager.GetInstance():Destroy()
	LightningEffectManager.GetInstance():Destroy()
	ElectricSkillManager.GetInstance():Destroy()
	FireStormSkillManager.GetInstance():Destroy()
	DrillSkillManager.GetInstance():Destroy()
	SerialDrillSkillManager.GetInstance():Destroy()
	BisonSkillManager.GetInstance():Destroy()
	BombSkillManager.GetInstance():Destroy()
	MultBombSkillManager.GetInstance():Destroy()
