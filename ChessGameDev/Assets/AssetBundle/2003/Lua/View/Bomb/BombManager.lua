...
function BombManager:AddScripts()
	self.ScriptsPathList={
		...
		"/View/Bomb/BoomType/BlackHoleFishType",
...
function BombManager:InitInstance()
	...
	self.BlackHoleFishType=BlackHoleFishType
end
...
function BombManager:BuildBombInstance(hitFishMsg)
	...
	elseif fishType==self.FishTBombype.BlackHoleType then
		bombIns=self.BlackHoleFishType.New()
	else
		if fishType>self.FishTBombype.SmallGameType then
			bombIns=self.NormalFishType.New()
		else
