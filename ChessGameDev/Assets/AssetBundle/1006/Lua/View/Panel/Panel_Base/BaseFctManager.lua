...
function BaseFctManager:IsShowFreeGameCount(isShow)
...
function BaseFctManager:ChangSceneAnim(index)
	self.PlayerStartView:ChangSceneAnim(index)
end


function BaseFctManager:SetFreeGameWinScore(score)
	self.PlayerStartView:SetFreeGameWinScore(score)
end
