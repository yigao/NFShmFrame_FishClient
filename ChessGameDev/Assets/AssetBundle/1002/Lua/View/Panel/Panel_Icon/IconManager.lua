...
function IconManager:CreateIconItemPool()
	for i=1,#self.IconItemList do
		GameObjectPoolManager.GetInstance():AddGameObjectPool(self.IconItemList[i],self.BuildMainItemCount,self.IconItemList[i].gameObject.name,GameObjectPoolManager.PoolType.IconPool)
	end
end
