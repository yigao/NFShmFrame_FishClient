LobbyHallFishModulePanel = Class()

function LobbyHallFishModulePanel:ctor()
    self:Init()
end

function LobbyHallFishModulePanel:Init(  )
    self:InitData()
    self:InitView()
end

function LobbyHallFishModulePanel:InitData(  )
...
function LobbyHallFishModulePanel:InitView(  )
...
function LobbyHallFishModulePanel:OpenUIPanel(go)
    self:GetUIComponent(go)

    self:ShowUIComponent()
end

function LobbyHallFishModulePanel:GetUIComponent(go)
    ...
    if self.returnEventScript ~= nil and self.returnEventScript.onMiniPointerClickCallBack == nil then
    ...
    if self.gameItemList == nil then
        ...
        for i = 1,#LobbyHallCoreSystem.GetInstance().gameItemDataList do
            ...
            if itemVo.gameType == LobbyHallCoreSystem.GetInstance().curSelectGameType then
...
function LobbyHallFishModulePanel:RemoveUIComponent()
    self.panelGameObject = nil
    self.panelTransform = nil
end

function LobbyHallFishModulePanel:ShowUIComponent()
...
function LobbyHallFishModulePanel:ReturnOnPointerClick(eventData)
...
function LobbyHallFishModulePanel:PlayAnimation(  )
...
function LobbyHallFishModulePanel:__delete()
    self:RemoveUIComponent()
end