LobbyHallArcadeModulePanel = Class()

function LobbyHallArcadeModulePanel:ctor()
    self:Init()
end

function LobbyHallArcadeModulePanel:Init(  )
    self:InitData()
    self:InitView()
end

function LobbyHallArcadeModulePanel:InitData(  )
...
function LobbyHallArcadeModulePanel:InitView(  )
...
function LobbyHallArcadeModulePanel:OpenUIPanel(go)
...
function LobbyHallArcadeModulePanel:GetUIComponent(go)
...
function LobbyHallArcadeModulePanel:RemoveUIComponent()
    self.panelGameObject = nil
    self.panelTransform = nil
end


function LobbyHallArcadeModulePanel:ShowUIComponent()    
...
function LobbyHallArcadeModulePanel:PlayAnimation(  )
...
function LobbyHallArcadeModulePanel:ReturnOnPointerClick(eventData)
...
function LobbyHallArcadeModulePanel:__delete()
    self:RemoveUIComponent()
end